...
enum class EndFieldExclusion : uint8 {
    ...
    EndFieldExclusion_DisableController_Hub,
    EndFieldExclusion_DisableController_ProgramAction,
    ...
    EndFieldExclusion_DisableController_Chadley,
    EndFieldExclusion_DiableController_Delay_FieldAttack,
    EndFieldExclusion_DisableController_CommunicatorAnimation,
