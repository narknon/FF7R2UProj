...
#include "EndBonamikBoxScaleGroupParamsComponent.generated.h"

class USQEX_Bonamik_ScaleGroupParamsPreset;

UCLASS(Blueprintable, EditInlineNew, ClassGroup=Custom, meta=(BlueprintSpawnableComponent))
class UEndBonamikBoxScaleGroupParamsComponent : public UBoxComponent {
    GENERATED_BODY()
public:
    ...
    UEndBonamikBoxScaleGroupParamsComponent(const FObjectInitializer& ObjectInitializer);
