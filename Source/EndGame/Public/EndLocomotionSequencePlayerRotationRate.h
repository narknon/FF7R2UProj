...
#include "EndLocomotionSequencePlayerRotationRate.generated.h"

USTRUCT(BlueprintType)
struct ENDGAME_API FEndLocomotionSequencePlayerRotationRate {
    GENERATED_BODY()
public:
    ...
    FEndLocomotionSequencePlayerRotationRate();
};
