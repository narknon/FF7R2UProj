...
#include "EndDataTableShootingCoasterNormalEnemyData.generated.h"

USTRUCT(BlueprintType)
struct FEndDataTableShootingCoasterNormalEnemyData : public FEndDataTableRowBase {
    GENERATED_BODY()
public:
private:
...
public:
    ENDDATAOBJECT_API FEndDataTableShootingCoasterNormalEnemyData();
};
