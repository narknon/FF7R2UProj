...
ASQEXSEADAudioVolume::ASQEXSEADAudioVolume(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    this->bColored = true;
    ...
    this->VolumeComponent->SetupAttachment(RootComponent);
}
