...
FSQEX_BonamikBodyDesc_v2::FSQEX_BonamikBodyDesc_v2() {
    this->m_Index = 0;
    this->m_ParentId = 0;
    this->m_ChildId = 0;
    this->m_GroupId = 0;
    ...
    this->m_ColShape = ESQEX_Bonamik_CollisionShape_v2_None;
    this->m_AddiConstType = ESQEX_Bonamik_ConstraintType_v2_None;
