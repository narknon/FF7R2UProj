...
#include "SQEX_Bonamik_ScaleGroupParamsPreset.generated.h"

UCLASS(Blueprintable)
class KBDRT_API USQEX_Bonamik_ScaleGroupParamsPreset : public UDataAsset {
    GENERATED_BODY()
public:
    ...
    USQEX_Bonamik_ScaleGroupParamsPreset();
